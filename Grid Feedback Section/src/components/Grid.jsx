  ...
  return (
    <div className="min-h-screen bg-gray-300 p-6 ">
      <div className="min-h-[600px] grid grid-cols-4 grid-rows-2 gap-5 m-10">
        <div className="p-4 px-8 pt-5 hover:scale-105 transition duration-500 bg-[#6EACDA] col-span-2  rounded-xl flex gap-2  shadow-lg">
          {" "}
          <div>
            ...
            <h1 className="text-lg font-semibold mb-2  font-Roboto">
        ...
        <div className="p-4 px-8 pt-5 hover:scale-105 transition duration-500 bg-[#021526] text-white col-start-3  rounded-xl flex gap-2 shadow-lg">
          {" "}
          <div>
            <div className="flex gap-2 ">
        ...
        <div className="p-4 px-8 pt-5 hover:scale-105 transition duration-500 bg-white row-span-2 rounded-xl flex gap-2 shadow-lg">
          {" "}
          <div>
            <div className="flex gap-2 ">
        ...
        <div className="p-4 px-8 pt-5 hover:scale-105 transition duration-500 bg-white rounded-xl flex gap-2 shadow-lg">
          {" "}
          <div>
            <div className="flex gap-2 ">
        ...
        <div className="p-4 px-8 pt-5 hover:scale-105 transition duration-500 bg-[#03346E] text-white col-span-2 rounded-xl flex gap-2 shadow-lg">
          {" "}
          <div>
            <div className="flex gap-2 ">
